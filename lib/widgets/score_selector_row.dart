...
class ScoreSelectorRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final bool isDescending =
        allowedScores != null &&
        allowedScores!.length > 1 &&
        allowedScores!.first > allowedScores!.last;
    ...
    return Row(
      children: players.map((player) {
        ...
        if (allowedScores != null) {
          canGoUp = isDescending
              ? currentIndex > 0
              : currentIndex < allowedScores!.length - 1;
          canGoDown = isDescending
              ? currentIndex < allowedScores!.length - 1
              : currentIndex > 0;
        } else {
